...
describe Speech do
  ...
  it "outputs a simple speech" do
    ...
    @speech.output(Builder::XmlMarkup.new).should == '<speech duration="0" id="uk.org.publicwhip/debate/2006-01-01.3.1" speakerid="uk.org.publicwhip/member/1" speakername="John Smith" talk="speech" time="05:00:00" url="http://foo.co.uk/"><p>A speech</p></speech>'
  end
  ...
  it "encodes html entities" do
    ...
    @speech.output(Builder::XmlMarkup.new).should == '<speech duration="0" id="uk.org.publicwhip/debate/2006-01-01.3.1" speakerid="uk.org.publicwhip/member/1" speakername="John Smith" talk="speech" time="05:00:00" url="http://foo.co.uk/"><p>Q&amp;A' + nbsp + '—</p></speech>'
  end  
end
